      ...
      <form>
        ...
        <div className='full'>
          <div class="fullform">
            ...
            <input className='text1' type="text" id="fname" name="fname" required 
              
              
            />     

            <label className='lb' for="lname">Last Name</label>
            <input className='text1' type="text" id="lname" name="lname" required 
              
            />
            <label className='lb' for="lname">Age </label>
            <input className='text1' type="number" id="lname" name="lname" required  min="0" max="120"
           ...
           &nbsp;&nbsp;&nbsp;
            ...
            <input className='text1' type="tel" id="phone" name="phone" pattern="[0-9]{3}[0-9]{3}[0-9]{4}" required 
              
            />

            <label className='lb' for="address">Address</label>
            
            <textarea id="address" name="address" required style={{ width: "580px", height: "100px" }} 
              
            ></textarea>
            <br />

            <label className='lb' for="emergency">Emergency Contact Number</label>
            <input className='text1' type="tel" id="emergency" name="emergency" pattern="[0-9]{3}[0-9]{3}[0-9]{4}" required 
            />
            <br />
